...
export const ENUMS: EnumDefinition[] = [
    ...
    },
    {
        ...
        values: [
            ...
            { value: "big_10", label: "BIG 10", description: "Big Ten Conference" },
            { value: "sec", label: "SEC", description: "Southeastern Conference" },
            { value: "acc", label: "ACC", description: "Atlantic Coast Conference" },
            { value: "big_12", label: "BIG 12", description: "Big 12 Conference" },
